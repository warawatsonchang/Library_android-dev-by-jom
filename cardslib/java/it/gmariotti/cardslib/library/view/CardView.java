            ...
            if (getOnExpandListAnimatorListener()!=null){
                ...
                mExpandAnimator.addListener(new AnimatorListenerAdapter() {
                	...
                	public void onAnimationStart(Animator animation) {
                		mCard.onExpandStart();
                		if(mCard.getOnExpandAnimatorStartListener() != null)
                			mCard.getOnExpandAnimatorStartListener().onExpandStart(mCard);
                	}
            ...
            if (getOnExpandListAnimatorListener()!=null){
                ...
                animator.addListener(new Animator.AnimatorListener() {
                    ...
                    public void onAnimationStart(Animator animator) {
                    	if(mCard.getOnCollapseAnimatorStartListener() != null)
                    		mCard.getOnCollapseAnimatorStartListener().onCollapseStart(mCard);
                    }
